                        ...
                        <div class="sub-menu">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('all.slider') }}">
                                    <span class="nav-text">Home Banner</span>

                                </a>
                            </li>
                            <li class="has-sub">
                                <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#homeabout" aria-expanded="false" aria-controls="homeabout">
                                    <span class="nav-text">Home About</span> <b class="caret"></b>
                                </a>
                                <ul class="collapse" id="homeabout">
                                    <div class="sub-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('home.about') }}">All About</a>
                                        </li>
